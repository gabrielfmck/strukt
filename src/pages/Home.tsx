...
const Home = () => {
    return (
      <div className="min-h-screen">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-primary-600 to-primary-800 text-white h-screen flex items-center">
        ...
        {/* Features Section - Agora começa logo após o hero sem espaço */}
